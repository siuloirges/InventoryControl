<?php namespace App\Http\Controllers;
	...
	class AdminCategories1Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
            ...
            $this->form[] = ['label'=>'Name','name'=>'name','type'=>'text','validation'=>'required|string','width'=>'col-sm-10','placeholder'=>'Nombre de categoria'];
            $this->form[] = ['label'=>'Descripcion','name'=>'Description','type'=>'textarea','validation'=>'string','width'=>'col-sm-10','placeholder'=>'Nombre de categoria'];
	    ...
	    */
	    public function hook_query_index(&$query) {
            if (!CRUDBooster::isSuperadmin()) {
                $store_id = DB::table('cms_users')->where('id', '=',CRUDBooster::myId() )->first()->stores_id;
                $query->where('categories.stores_id',  $store_id);
            }
	    }
