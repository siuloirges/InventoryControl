<?php namespace App\Http\Controllers;
	...
	class AdminSuppliers1Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
            ...
            $this->col[] = ["label"=>"Credito maximo","name"=>"credit"];
			...
			$this->form[] = ['label'=>'Teléfono','name'=>'phone','type'=>'number','validation'=>'required|numeric','width'=>'col-sm-10','placeholder'=>'Puedes introducir solo un número'];
			$this->form[] = ['label'=>'Teléfono 2','name'=>'phone_other','type'=>'number','validation'=>'numeric','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Correo Electronico','name'=>'email','type'=>'text','validation'=>'string','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Credito maximo','name'=>'credit','type'=>'text','validation'=>'numeric','width'=>'col-sm-10'];
	    ...
	    */
	    public function hook_query_index(&$query) {
            if (!CRUDBooster::isSuperadmin()) {
                $store_id = DB::table('cms_users')->where('id', '=',CRUDBooster::myId() )->first()->stores_id;
                $query->where('suppliers.stores_id',  $store_id);
            }
