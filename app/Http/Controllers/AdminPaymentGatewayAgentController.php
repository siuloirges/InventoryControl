<?php namespace App\Http\Controllers;
	...
	class AdminPaymentGatewayAgentController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "payment_gateway_agent";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Nombre","name"=>"name"];
			$this->col[] = ["label"=>"Identificador","name"=>"agent_identifier_code"];
			...
			$this->form[] = ['label'=>'Identificador','name'=>'agent_identifier_code','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Agent Identifier Code","name"=>"agent_identifier_code","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			# OLD END FORM
